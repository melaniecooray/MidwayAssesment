...
class LoginVC: UIViewController {
    ...
    func handleLogin() {
        ...
        if emailTextField.text == "" {
            ...
            displayAlert(title: "Error:", message: "Email not provided")
            return
        }
        
        if passwordTextField.text == "" {
            self.loginRegisterButton.isUserInteractionEnabled = true
            displayAlert(title: "Error:", message: "Password not provided")
            return
        }
    ...
    func handleRegister() {
        ...
        if nameTextField.text == "" {
            self.loginRegisterButton.isUserInteractionEnabled = true
            displayAlert(title: "Error:", message: "Name not provided")
            return
        }
        ...
        if phoneNumberTextField.text == "" {
            self.loginRegisterButton.isUserInteractionEnabled = true
            displayAlert(title: "Error:", message: "Phone Number not provided")
            return
        }
